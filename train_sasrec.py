...
from algorithms.sasrec import SASRec
...
parser.add_argument('--dataset', required=True,default="/content/drive/MyDrive/SSC/data/movie.txt")
...
if __name__ == '__main__':
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        if epoch == args.num_epochs:
            score = evaluate(model, dataset, args)
            print("NDGC score is :", score)
